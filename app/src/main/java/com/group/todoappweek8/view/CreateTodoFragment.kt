...
class CreateTodoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnAdd.setOnClickListener {
            ...
            var radioBtn = view.findViewById<RadioButton>(radio.checkedRadioButtonId)

            var todo = Todo(txtTitle.text.toString(), txtNotes.text.toString(), radioBtn.tag.toString().toInt())
